					...
					function (p, resultParamCtx) {
						return A2(
							...
							function (c) {
								...
								var _v15 = A2($author$project$HdlChecker$newTVar, p.size, c);
			...
			return A2(
				...
				function (_v12) {
					...
					var paramTypes = A2(
						$elm$core$List$map,
						function (p) {
							var _v14 = A2($author$project$HdlChecker$getTypeFromCtx, p.name.value, outputCtx);
							if (_v14.$ === 'Just') {
								var t = _v14.a;
								return t;
							} else {
									...
									F2(
										function (binding, ctx1) {
											return A2(
												$elm$core$Result$andThen,
												function (c1) {
													var _v9 = A2($author$project$HdlChecker$newTVar, binding, c1);
													var t = _v9.a;
													var ctx2 = _v9.b;
									...
									return A2(
										...
										function (_v3) {
											...
											if (def.$ === 'FuncDef') {
												...
												return $elm$core$Result$Ok(
													_Utils_Tuple2(
														A3($author$project$HdlChecker$addToCtxAllowDuplicates, name, defType, defCtx),
														nextSubst));
											} else {
												var name = def.a.name;
												var _v5 = name.value;
																...
																A3(
																	...
																	F3(
																		function (k, v, nextCtx) {
																			...
																			if (_v7.$ === 'Just') {
																				var t = _v7.a;
																				return A3($author$project$HdlChecker$addToCtxAllowDuplicates, v, t, nextCtx);
																			} else {
																				return nextCtx;
																			}
																		}),
...
var $author$project$HdlEmitter$emitExpr = function (e) {
	switch (e.$) {
		...
		case 'Indexing':
			...
			var andFilter = '0b' + A2($elm$core$String$repeat, (from.value - to.value) + 1, '1');
