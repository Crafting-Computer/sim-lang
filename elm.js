...
var $author$project$HdlChecker$addToCtxAllowDuplicates = F3(
	function (n, t, c) {
		return _Utils_update(
			c,
			{
				env: A3($pzp1997$assoc_list$AssocList$insert, n, t, c.env)
			});
	});
...
var $author$project$HdlChecker$getLocatedNameAndTypeFromCtx = F2(
	function (name, ctx) {
		var locatedName = A2(
			$elm_community$list_extra$List$Extra$find,
			function (k) {
				return _Utils_eq(k.value, name);
			},
			$pzp1997$assoc_list$AssocList$keys(ctx.env));
		return A2(
			...
			function (n) {
				return A2(
					...
					A2($pzp1997$assoc_list$AssocList$get, n, ctx.env));
			},
			locatedName);
	});
var $author$project$HdlParser$withLocation = F2(
	function (loc, value) {
		return {from: loc.from, to: loc.to, value: value};
	});
var $author$project$HdlChecker$addToCtx = F3(
	function (n, t, c) {
		var _v0 = A2($author$project$HdlChecker$getLocatedNameAndTypeFromCtx, n.value, c);
		if (_v0.$ === 'Nothing') {
			return $elm$core$Result$Ok(
				A3($author$project$HdlChecker$addToCtxAllowDuplicates, n, t, c));
		} else {
			var _v1 = _v0.a;
			var n2 = _v1.a;
			return $elm$core$Result$Err(
				_List_fromArray(
					[
						A2(
						$author$project$HdlChecker$DuplicatedName,
						A2($author$project$HdlParser$withLocation, n2, n.value),
						n)
					]));
		}
	});
...
var $author$project$HdlChecker$TFun = F2(
	function (a, b) {
		return {$: 'TFun', a: a, b: b};
	});
var $author$project$HdlChecker$TVar = function (a) {
	return {$: 'TVar', a: a};
};
...
var $author$project$HdlChecker$createTFunFromTypes = F2(
	function (paramTypes, outputType) {
		var createTFunHelper = function (types) {
			if (types.b) {
				if (!types.b.b) {
					var singleType = types.a;
					return singleType;
				} else {
					var fromType = types.a;
					var restTypes = types.b;
					return {
						from: fromType.from,
						to: A2(
							...
							A2(
								...
								$elm_community$list_extra$List$Extra$last(restTypes))),
						value: A2(
							$author$project$HdlChecker$TFun,
							fromType,
							createTFunHelper(restTypes))
					};
				}
			} else {
		...
		return createTFunHelper(
			_Utils_ap(
				paramTypes,
				_List_fromArray(
					[outputType])));
	});
var $author$project$HdlChecker$EqualToSize = {$: 'EqualToSize'};
var $author$project$HdlChecker$TBus = F2(
	function (a, b) {
		return {$: 'TBus', a: a, b: b};
	});
var $author$project$HdlChecker$paramToType = function (p) {
	return A2($author$project$HdlChecker$TBus, p.size.value, $author$project$HdlChecker$EqualToSize);
};
var $author$project$HdlChecker$paramToLocatedType = function (p) {
	return A2(
		$author$project$HdlParser$withLocation,
		p.size,
		$author$project$HdlChecker$paramToType(p));
};
var $author$project$HdlChecker$TRecord = function (a) {
	return {$: 'TRecord', a: a};
};
...
var $author$project$HdlChecker$paramsToTRecord = function (params) {
	var paramTypes = A2($elm$core$List$map, $author$project$HdlChecker$paramToLocatedType, params.value);
	var paramNames = A2(
		$elm$core$List$map,
		function (p) {
			return p.name.value;
		...
		params.value);
	if (paramTypes.b && (!paramTypes.b.b)) {
		var singleType = paramTypes.a;
		return singleType;
	} else {
		return A2(
			$author$project$HdlParser$withLocation,
			params,
			$author$project$HdlChecker$TRecord(
				$pzp1997$assoc_list$AssocList$fromList(
					$elm$core$List$reverse(
						A3($elm$core$List$map2, $elm$core$Tuple$pair, paramNames, paramTypes)))));
	}
};
var $author$project$HdlChecker$createTFun = F2(
	function (params, outputs) {
		var paramTypes = A2($elm$core$List$map, $author$project$HdlChecker$paramToLocatedType, params);
		var outputType = $author$project$HdlChecker$paramsToTRecord(outputs);
		return A2($author$project$HdlChecker$createTFunFromTypes, paramTypes, outputType);
	});
var $pzp1997$assoc_list$AssocList$empty = $pzp1997$assoc_list$AssocList$D(_List_Nil);
var $author$project$HdlChecker$emptyCtx = {env: $pzp1997$assoc_list$AssocList$empty, level: 0, nextId: 0};
...
var $author$project$HdlChecker$ExpectingRecord = function (a) {
	return {$: 'ExpectingRecord', a: a};
};
var $author$project$HdlChecker$UnexpectedBindingRecordKey = F2(
	function (a, b) {
		return {$: 'UnexpectedBindingRecordKey', a: a, b: b};
	});
	...
	function (subst, t) {
		...
		switch (_v0.$) {
			case 'TBus':
				...
				if (subst.$ === 'Subst') {
					var s = subst.a;
					var _v2 = A2($pzp1997$assoc_list$AssocList$get, name, s);
					if (_v2.$ === 'Just') {
						var busType = _v2.a;
						return busType;
					} else {
				...
				return A2(
					...
					$author$project$HdlChecker$TRecord(
						A2(
							...
							F2(
								function (k, v) {
									return A2($author$project$HdlChecker$applySubstToType, subst, v);
								}),
							r)));
			case 'TFun':
				var from = _v0.a;
				...
				return A2(
					...
					A2(
						$author$project$HdlChecker$TFun,
						A2($author$project$HdlChecker$applySubstToType, subst, from),
						A2($author$project$HdlChecker$applySubstToType, subst, to)));
			default:
				var id = _v0.a;
				if (subst.$ === 'Subst') {
					var s = subst.a;
					var _v5 = A2($pzp1997$assoc_list$AssocList$get, id, s);
					if (_v5.$ === 'Just') {
						var varType = _v5.a;
						return varType;
					} else {
...
var $author$project$HdlChecker$applySubstToCtx = F2(
	function (subst, ctx) {
		return _Utils_update(
			ctx,
			{
...
var $author$project$HdlChecker$SubstError = function (a) {
	return {$: 'SubstError', a: a};
};
...
var $author$project$HdlChecker$combineSubsts = F2(
	function (subst1, subst2) {
		var _v0 = _Utils_Tuple2(subst1, subst2);
		if (_v0.a.$ === 'Subst') {
			if (_v0.b.$ === 'Subst') {
				var s1 = _v0.a.a;
				var s2 = _v0.b.a;
				return $author$project$HdlChecker$Subst(
					A2(
						...
						A2(
							...
							F2(
								function (k, v) {
									return A2($author$project$HdlChecker$applySubstToType, subst1, v);
								}),
							s2),
						s1));
			} else {
			...
			if (_v0.b.$ === 'Subst') {
				...
				var s1 = _v0.a.a;
				var s2 = _v0.b.a;
				return $author$project$HdlChecker$SubstError(
					_Utils_ap(s2, s1));
			}
		}
	});
...
var $author$project$HdlChecker$emptySubst = $author$project$HdlChecker$Subst($pzp1997$assoc_list$AssocList$empty);
...
var $author$project$HdlChecker$getTargetNamesFromDef = function (def) {
	if (def.$ === 'FuncDef') {
		var name = def.a.name;
		return _List_fromArray(
			[name.value]);
...
var $author$project$HdlChecker$getTypeFromCtx = F2(
	function (name, ctx) {
		return A2(
			$elm$core$Maybe$map,
			$elm$core$Tuple$second,
			A2($author$project$HdlChecker$getLocatedNameAndTypeFromCtx, name, ctx));
	});
var $author$project$HdlChecker$incrementLevel = function (ctx) {
	return _Utils_update(
		ctx,
		{level: ctx.level + 1});
};
...
var $author$project$HdlChecker$GreaterThanSize = {$: 'GreaterThanSize'};
...
var $author$project$HdlChecker$WrongCallArity = F3(
	function (a, b, c) {
...
var $author$project$HdlChecker$newTVar = F2(
...
var $author$project$HdlChecker$paramTypesFromTFun = function (funcType) {
	var _v0 = funcType.value;
	if (_v0.$ === 'TFun') {
		var from = _v0.a;
		var to = _v0.b;
		return A2(
			$elm$core$List$cons,
			from,
			$author$project$HdlChecker$paramTypesFromTFun(to));
	} else {
		return _List_Nil;
	}
};
...
var $author$project$HdlChecker$contains = F2(
	function (id1, t) {
		switch (t.$) {
			case 'TVar':
				var id2 = t.a;
			...
			case 'TFun':
				var from = t.a;
				var to = t.b;
				return A2($author$project$HdlChecker$contains, id1, from.value) || A2($author$project$HdlChecker$contains, id1, to.value);
			default:
				return false;
		}
	});
	...
	function (id1, t) {
		var testContains = A2($author$project$HdlChecker$contains, id1.value, t.value) ? $author$project$HdlChecker$SubstError(
			_List_fromArray(
				[
					A2(
					$author$project$HdlChecker$MismatchedTypes,
					A2(
						$author$project$HdlParser$withLocation,
						id1,
...
var $author$project$HdlChecker$unify = F2(
	function (t1, t2) {
		var mismatch = $author$project$HdlChecker$SubstError(
			_List_fromArray(
				[
					A2($author$project$HdlChecker$MismatchedTypes, t1, t2)
				]));
							...
							case 'TBus':
								...
								if (_v3.a.$ === 'VarSize') {
									...
									if (_v3.b.$ === 'VarSize') {
										...
										if (_v4.a.$ === 'GreaterThanSize') {
											if (_v4.b.$ === 'GreaterThanSize') {
												var _v5 = _v4.a;
												var _v6 = _v4.b;
												return (_Utils_cmp(i1, i2) > -1) ? subst1 : subst2;
											} else {
												var _v7 = _v4.a;
												var _v8 = _v4.b;
												return (_Utils_cmp(i1, i2) > -1) ? mismatch : subst2;
											}
										} else {
											if (_v4.b.$ === 'GreaterThanSize') {
												var _v9 = _v4.a;
												var _v10 = _v4.b;
												return (_Utils_cmp(i2, i1) > -1) ? mismatch : subst1;
											} else {
												var _v11 = _v4.a;
												var _v12 = _v4.b;
												return (_Utils_cmp(i1, i2) > -1) ? $author$project$HdlChecker$emptySubst : mismatch;
											}
										}
									}
								}
						...
						switch (_v0.b.$) {
							case 'TRecord':
								...
								return $pzp1997$assoc_list$AssocList$isEmpty(
									A2(
										$pzp1997$assoc_list$AssocList$union,
										A2($pzp1997$assoc_list$AssocList$diff, r1, r2),
										A2($pzp1997$assoc_list$AssocList$diff, r2, r1))) ? A3(
									$pzp1997$assoc_list$AssocList$foldl,
									F3(
										function (k, v1, resultSubst) {
											var v2 = A2(
												$elm$core$Maybe$withDefault,
												v1,
												A2($pzp1997$assoc_list$AssocList$get, k, r2));
											return A2(
												$author$project$HdlChecker$combineSubsts,
												resultSubst,
												A2($author$project$HdlChecker$unify, v1, v2));
										}),
					...
					case 'TFun':
						switch (_v0.b.$) {
							case 'TFun':
								...
								var from2 = _v14.a;
								var to2 = _v14.b;
								var toSubst = A2($author$project$HdlChecker$unify, to1, to2);
								var fromSubst = A2($author$project$HdlChecker$unify, from1, from2);
								return A2($author$project$HdlChecker$combineSubsts, fromSubst, toSubst);
							case 'TVar':
								break _v0$4;
							default:
								break _v0$5;
...
var $author$project$HdlChecker$inferExpr = F2(
	function (ctx, expr) {
		var _v0 = expr.value;
		switch (_v0.$) {
			case 'Binding':
				var name = _v0.a;
				var _v1 = A2($author$project$HdlChecker$getTypeFromCtx, name.value, ctx);
				if (_v1.$ === 'Just') {
					var t = _v1.a;
					return $elm$core$Result$Ok(
						_Utils_Tuple3(t, ctx, $author$project$HdlChecker$emptySubst));
				} else {
					return $elm$core$Result$Err(
						_List_fromArray(
							[
								$author$project$HdlChecker$UndefinedName(name)
							]));
				}
			case 'IntLiteral':
				var size = _v0.a;
							...
							A2(
								...
								$author$project$HdlParser$IntSize(
									$icidasset$elm_binary$Binary$width(
										$icidasset$elm_binary$Binary$fromDecimal(size.value))),
				...
				return A2(
					...
					function (_v3) {
							...
							switch (_v5.$) {
								case 'TBus':
									...
									if (_Utils_cmp(from.value, to.value) > 0) {
										...
										if (size.$ === 'IntSize') {
											var s = size.a;
											return (_Utils_cmp(to.value, s) > -1) ? _Utils_Tuple2(
												$elm$core$Result$Ok(
													A2(
														$author$project$HdlParser$withLocation,
														expr,
												...
												$author$project$HdlChecker$Subst(
													A2(
														...
														A2(
															...
															A2(
																$author$project$HdlChecker$TBus,
																$author$project$HdlParser$IntSize(to.value),
																$author$project$HdlChecker$GreaterThanSize))))) : _Utils_Tuple2(
												$elm$core$Result$Ok(
													A2(
														$author$project$HdlParser$withLocation,
														expr,
								...
								default:
									...
									return (_Utils_cmp(from.value, to.value) > 0) ? _Utils_Tuple2(
										...
										$author$project$HdlChecker$emptySubst) : _Utils_Tuple2(
										$elm$core$Result$Ok(
											A2(
												$author$project$HdlParser$withLocation,
												expr,
						...
						return A2(
							$elm$core$Result$map,
							function (indexingT) {
								return _Utils_Tuple3(indexingT, resultCtx, resultSubst);
							},
							indexingType);
					},
					A2($author$project$HdlChecker$inferExpr, ctx, e));
			case 'Record':
				var r = _v0.a;
				return A2(
					$elm$core$Result$map,
					$TSFoster$elm_tuple_extra$Tuple3$mapFirst(
						A2(
							...
							$author$project$HdlParser$withLocation(r),
							$author$project$HdlChecker$TRecord)),
					A3(
						$pzp1997$assoc_list$AssocList$foldl,
						F3(
								...
								return A2(
									...
									function (_v7) {
										...
										return A2(
											...
											A2($author$project$HdlChecker$inferExpr, resultCtx, v));
									},
									result);
							}),
						$elm$core$Result$Ok(
						...
						return A2(
							...
							function (_v11) {
								...
								var s4 = A2(
									...
									funcType,
									A2($author$project$HdlChecker$createTFunFromTypes, argTypes, outputType));
								var funcType1 = A2($author$project$HdlChecker$applySubstToType, s4, funcType);
								var paramTypes = $author$project$HdlChecker$paramTypesFromTFun(funcType1);
								if (!_Utils_eq(
									$elm$core$List$length(paramTypes),
									$elm$core$List$length(argTypes))) {
									return $elm$core$Result$Err(
										_List_fromArray(
											[
												A3(
									...
									var callResult = A3(
													...
													function (_v14) {
														...
														if (_v15.$ === 'TFun') {
															...
															return $elm$core$Result$Err(
																_List_fromArray(
																	[
																		A2($author$project$HdlChecker$MismatchedTypes, nextType, argType)
																	]));
														}
													},
													result);
										...
										$elm$core$Result$Ok(
											_Utils_Tuple2(
												funcType1,
												A2($author$project$HdlChecker$combineSubsts, s3, s4))),
										argTypes);
									return A2(
										$elm$core$Result$map,
										function (_v13) {
											...
											function (_v10) {
												...
												return A2(
													...
													A2(
														...
														A2($author$project$HdlChecker$applySubstToCtx, nextSubst, nextCtx),
														arg));
											},
											argResult);
									}),
								$elm$core$Result$Ok(
									_Utils_Tuple3(_List_Nil, c1, $author$project$HdlChecker$emptySubst)),
								args));
					},
					A2(
						$author$project$HdlChecker$inferExpr,
							...
							case 'TBus':
								...
								if (_v3.a.$ === 'VarSize') {
									...
									if (_v3.b.$ === 'VarSize') {
										...
										return matchSuccess ? success : mismatch;
									}
								}
							case 'TVar':
								break _v0$5;
								...
								return $pzp1997$assoc_list$AssocList$isEmpty(
									...
									F3(
										function (k, v1, resultMatch) {
											...
											return _Utils_ap(
												resultMatch,
												A2($author$project$HdlChecker$match, v1, v2));
										}),
									_List_Nil,
									r1) : mismatch;
							case 'TVar':
...
var $author$project$HdlChecker$inferDef = F2(
	function (ctx, def) {
		if (def.$ === 'BindingDef') {
			...
			var body = def.a.body;
			return (ctx.level <= 0) ? $elm$core$Result$Err(
				_List_fromArray(
					[
			...
			var paramCtx = A3(
				...
				$elm$core$Result$Ok(ctx),
				params);
			return A2(
				$elm$core$Result$andThen,
				function (_v17) {
					var outputType1 = _v17.a;
					var outputCtx1 = _v17.b;
					var outputSubst = _v17.c;
				...
				A2(
					$elm$core$Result$andThen,
					function (c) {
						return A3($author$project$HdlChecker$inferLocalsAndBody, c, locals, body);
					},
					paramCtx));
		}
	});
var $author$project$HdlChecker$inferDefs = F2(
	function (ctx, defs) {
		var declaredCtx = A3(
			$elm$core$List$foldl,
			F2(
				function (d, nextCtx) {
					return A2(
						...
						function (nextCtx1) {
							if (d.$ === 'FuncDef') {
								var name = d.a.name;
								var params = d.a.params;
								var outputs = d.a.outputs;
								return A3(
									$author$project$HdlChecker$addToCtx,
									name,
									A2($author$project$HdlChecker$createTFun, params, outputs),
									nextCtx1);
							} else {
								var name = d.a.name;
									...
									F2(
										function (binding, ctx1) {
											return A2(
												$elm$core$Result$andThen,
												function (c1) {
													var _v14 = A2($author$project$HdlChecker$newTVar, binding, c1);
													var t = _v14.a;
													var ctx2 = _v14.b;
													return A3($author$project$HdlChecker$addToCtx, binding, t, ctx2);
												},
												ctx1);
										}),
									$elm$core$Result$Ok(nextCtx1),
									bindings);
								return bindingCtx;
							}
						},
											...
											if (def.$ === 'FuncDef') {
												...
												var defCtx1 = _Utils_update(
													defCtx,
													{
														env: A2(
															...
															F2(
																function (k, _v5) {
																	return !A2($elm$core$List$member, k.value, funcScopeNames);
																}),
															defCtx.env)
													});
												return $elm$core$Result$Ok(
													_Utils_Tuple2(
														A3($author$project$HdlChecker$addToCtxAllowDuplicates, name, defType, defCtx1),
														nextSubst));
											} else {
												var name = def.a.name;
												var locals = def.a.locals;
												var bindingScopeNames = $elm$core$List$concat(
													A2($elm$core$List$map, $author$project$HdlChecker$getTargetNamesFromDef, locals));
												var defCtx1 = _Utils_update(
													defCtx,
													{
														env: A2(
															...
															F2(
																function (k, _v12) {
																	return !A2($elm$core$List$member, k.value, bindingScopeNames);
																}),
															defCtx.env)
													});
												var _v6 = name.value;
												if (_v6.$ === 'BindingName') {
													...
													return $elm$core$Result$Ok(
														_Utils_Tuple2(
															A3(
																$author$project$HdlChecker$addToCtxAllowDuplicates,
																A2($author$project$HdlParser$withLocation, name, n),
																defType,
																defCtx1),
															nextSubst));
													...
													if (_v7.$ === 'TRecord') {
														...
														var keys = $elm$core$List$reverse(
															$pzp1997$assoc_list$AssocList$keys(r));
														var duplicatedRecordKeys = A3(
															$elm$core$List$foldl,
															F2(
																function (firstKey, duplicates) {
																	if (duplicates.$ === 'Nothing') {
																		return A2(
																			$elm$core$Maybe$map,
																			function (secondKey) {
																				return _Utils_Tuple2(firstKey, secondKey);
																			},
																			A2(
																				$elm_community$list_extra$List$Extra$find,
																				function (otherKey) {
																					return _Utils_eq(otherKey.value, firstKey.value);
																				},
																				A2(
																					$elm$core$List$filter,
																					$elm$core$Basics$neq(firstKey),
																					keys)));
																	} else {
																		return duplicates;
																	}
															...
															$elm$core$Maybe$Nothing,
															keys);
														if (duplicatedRecordKeys.$ === 'Nothing') {
															return A2(
																$elm$core$Result$map,
																function (c) {
																	return _Utils_Tuple2(c, nextSubst);
																},
																A3(
																	$pzp1997$assoc_list$AssocList$foldl,
																	F3(
																		function (k, v, nextCtx) {
																			return A2(
																				$elm$core$Result$andThen,
																				function (c) {
																					var _v9 = A2($pzp1997$assoc_list$AssocList$get, k.value, typeRecord);
																					if (_v9.$ === 'Just') {
																						var t = _v9.a;
																						return $elm$core$Result$Ok(
																							A3($author$project$HdlChecker$addToCtxAllowDuplicates, v, t, c));
																					} else {
																						return $elm$core$Result$Err(
																							_List_fromArray(
																								[
																									A2($author$project$HdlChecker$UnexpectedBindingRecordKey, k, typeRecord)
																								]));
																					}
																				},
																				nextCtx);
																		}),
																	$elm$core$Result$Ok(defCtx1),
																	r));
														} else {
															var _v10 = duplicatedRecordKeys.a;
															var firstKey = _v10.a;
															var secondKey = _v10.b;
															return $elm$core$Result$Err(
																_List_fromArray(
																	[
																		A2($author$project$HdlChecker$DuplicatedBindingRecordKey, firstKey, secondKey)
																	]));
														}
													} else {
														return $elm$core$Result$Err(
															_List_fromArray(
																[
																	$author$project$HdlChecker$ExpectingRecord(defType)
																]));
													}
												}
											}
										},
										A2($author$project$HdlChecker$inferDef, resultCtx, def));
								},
								result);
						}),
					$elm$core$Result$Ok(
						_Utils_Tuple2(declaredCtx1, $author$project$HdlChecker$emptySubst)),
					defs);
			},
			declaredCtx);
	});
var $author$project$HdlChecker$inferLocalsAndBody = F3(
	function (ctx, locals, body) {
		return A2(
			$elm$core$Result$andThen,
			function (_v0) {
				var localCtx = _v0.a;
				...
				return A2(
					...
					function (_v1) {
						...
						return _Utils_Tuple3(
							A2($author$project$HdlChecker$applySubstToType, resultSubst, bodyType),
							resultCtx,
							resultSubst);
					},
					A2($author$project$HdlChecker$inferExpr, localCtx, body));
			},
			A2(
				$author$project$HdlChecker$inferDefs,
				$author$project$HdlChecker$incrementLevel(ctx),
				locals));
	});
...
var $author$project$HdlChecker$preludeFuncDef = F3(
	function (name, params, outputs) {
		return $author$project$HdlParser$FuncDef(
			{
				body: $author$project$HdlParser$fakeLocated(
...
var $author$project$HdlChecker$check = function (defs) {
	var allDefs = _Utils_ap($author$project$HdlChecker$prelude, defs);
	var ctx = A3(
		$elm$core$List$foldl,
		F2(
			function (d, nextCtx) {
		...
		$elm$core$Result$Ok($author$project$HdlChecker$emptyCtx),
		allDefs);
	var problems = A3(
		$elm$core$List$foldl,
		F2(
			function (def, ps) {
				if (ctx.$ === 'Ok') {
					...
					var defCtx = _Utils_update(
						c,
						{
							env: A2(
								...
								F2(
									function (k, _v12) {
										return !A2($elm$core$List$member, k.value, defNames);
									}),
								c.env)
						});
					var _v9 = A2($author$project$HdlChecker$inferDef, defCtx, def);
					if (_v9.$ === 'Err') {
						var defProblems = _v9.a;
					...
					var ctxProblems = ctx.a;
					return _Utils_ap(ctxProblems, ps);
				}
			}),
		_List_Nil,
		defs);
	...
	switch (e.$) {
		...
		case 'Record':
			...
			return A3(
				...
				F3(
					function (k, v, str) {
						return str + (k.value + (' : ' + ($author$project$HdlEmitter$emitExpr(v.value) + ', ')));
					}),
				'{ ',
				r.value) + ' }';
		default:
...
var $author$project$HdlEmitter$emitLocals = F3(
	function (indent, declareVars, defs) {
		var orderedLocals = A2(
			...
			F2(
				function (d1, d2) {
					var t2 = $author$project$HdlChecker$getTargetNamesFromDef(d2);
					var t1 = $author$project$HdlChecker$getTargetNamesFromDef(d1);
					var n2 = $author$project$HdlChecker$getSourceNamesFromDef(d2);
					var secondDependsOnFirst = A2(
						...
						n2);
					var n1 = $author$project$HdlChecker$getSourceNamesFromDef(d1);
...
var $author$project$HdlParser$BindingDef = function (a) {
	return {$: 'BindingDef', a: a};
};
...
var $author$project$HdlParser$ExpectingComma = {$: 'ExpectingComma'};
var $author$project$HdlParser$ExpectingEqual = {$: 'ExpectingEqual'};
var $author$project$HdlParser$ExpectingIn = {$: 'ExpectingIn'};
var $author$project$HdlParser$ExpectingLeftBrace = {$: 'ExpectingLeftBrace'};
...
var $author$project$HdlParser$checkIndentHelp = function (_v0) {
	var parser = _v0.a;
	var isIndented = _v0.b;
	var actualIndentation = _v0.c;
	return isIndented ? A2($elm$parser$Parser$Advanced$withIndent, actualIndentation, parser) : $elm$parser$Parser$Advanced$problem($author$project$HdlParser$ExpectingIndent);
};
...
var $author$project$HdlParser$checkIndent = function (parser) {
	return A2(
		$elm$parser$Parser$Advanced$andThen,
		$author$project$HdlParser$checkIndentHelp,
		A2(
				...
				$elm$parser$Parser$Advanced$succeed(
					F2(
						function (indentation, column) {
							return _Utils_Tuple3(
								parser,
								_Utils_cmp(indentation, column) < 0,
								column - 1);
						})),
...
var $author$project$HdlParser$integer = A2(
	...
	$elm$parser$Parser$Advanced$getChompedString(
		A2(
			...
			A2(
				...
				A2($elm$parser$Parser$Advanced$chompIf, $elm$core$Char$isDigit, $author$project$HdlParser$ExpectingInt)),
			$elm$parser$Parser$Advanced$chompWhile($elm$core$Char$isDigit))));
var $author$project$HdlParser$Located = F3(
...
var $author$project$HdlParser$located = function (parser) {
	return A2(
		$elm$parser$Parser$Advanced$keeper,
		A2(
			$elm$parser$Parser$Advanced$keeper,
			A2(
				$elm$parser$Parser$Advanced$keeper,
				$elm$parser$Parser$Advanced$succeed($author$project$HdlParser$Located),
...
var $author$project$HdlParser$optional = function (parser) {
...
var $author$project$HdlParser$ExpectingEndOfMultiLineComment = {$: 'ExpectingEndOfMultiLineComment'};
var $author$project$HdlParser$ExpectingStartOfLineComment = {$: 'ExpectingStartOfLineComment'};
var $author$project$HdlParser$ExpectingStartOfMultiLineComment = {$: 'ExpectingStartOfMultiLineComment'};
var $elm$parser$Parser$Advanced$Nestable = {$: 'Nestable'};
var $elm$parser$Parser$Advanced$getOffset = $elm$parser$Parser$Advanced$Parser(
	function (s) {
		return A3($elm$parser$Parser$Advanced$Good, false, s.offset, s);
	});
var $author$project$HdlParser$ifProgress = F2(
...
var $author$project$HdlParser$sps = A2(
	...
	0,
	$author$project$HdlParser$ifProgress(
		$elm$parser$Parser$Advanced$oneOf(
			_List_fromArray(
				[
					...
					A2($elm$parser$Parser$Advanced$Token, '-}', $author$project$HdlParser$ExpectingEndOfMultiLineComment),
					$elm$parser$Parser$Advanced$Nestable),
					$elm$parser$Parser$Advanced$spaces
				]))));
var $author$project$HdlParser$indexing = A2(
	$elm$parser$Parser$Advanced$keeper,
	A2(
		$elm$parser$Parser$Advanced$keeper,
		A2(
				...
				A2(
					...
					A2(
						...
						A2(
							...
							$elm$parser$Parser$Advanced$succeed($elm$core$Basics$identity),
							$elm$parser$Parser$Advanced$token(
								A2($elm$parser$Parser$Advanced$Token, '..', $author$project$HdlParser$ExpectingDotDot))),
						$author$project$HdlParser$sps),
					$author$project$HdlParser$located($author$project$HdlParser$integer))),
			$author$project$HdlParser$sps),
		$elm$parser$Parser$Advanced$token(
...
var $author$project$HdlParser$name = $author$project$HdlParser$located(
	$elm$parser$Parser$Advanced$variable(
		{
			expecting: $author$project$HdlParser$ExpectingName,
			inner: function (c) {
				return $elm$core$Char$isAlphaNum(c) || _Utils_eq(
					c,
					_Utils_chr('_'));
			},
			reserved: $author$project$HdlParser$reserved,
			start: $elm$core$Char$isLower
		}));
var $author$project$HdlParser$binding = $author$project$HdlParser$checkIndent(
	A2(
		$elm$parser$Parser$Advanced$keeper,
		A2(
			$elm$parser$Parser$Advanced$keeper,
						...
						if (i.$ === 'Just') {
							...
							return A2(
								...
								A2(
									$author$project$HdlParser$withLocation,
									n,
									$author$project$HdlParser$Binding(n)),
								indexes);
						} else {
							return $author$project$HdlParser$Binding(n);
						}
					})),
...
var $author$project$HdlParser$ExpectingSpaces = {$: 'ExpectingSpaces'};
var $author$project$HdlParser$sps1 = A2(
	$elm$parser$Parser$Advanced$andThen,
	function (str) {
							...
							_List_fromArray(
								[
									...
									A2(
										...
										$elm$parser$Parser$Advanced$backtrackable($author$project$HdlParser$sps1)),
									$author$project$HdlParser$located(
										$elm$parser$Parser$Advanced$oneOf(
											_List_fromArray(
												[
...
try {
	...
	$author$project$HdlParser$cyclic$bindingOrCall = function () {
		return $author$project$HdlParser$bindingOrCall;
	};
	var $author$project$HdlParser$group = $author$project$HdlParser$cyclic$group();
...
var $author$project$HdlParser$indent = function (parser) {
	return A2(
		$elm$parser$Parser$Advanced$andThen,
							...
							A2(
								...
								function (n) {
									return A2(
										$author$project$HdlParser$withLocation,
										n,
										$author$project$HdlParser$BindingName(n.value));
								},
								$author$project$HdlParser$name)),
							A2(
							$elm$parser$Parser$Advanced$keeper,
							$elm$parser$Parser$Advanced$succeed(
								function (locatedList) {
									return A2(
										$author$project$HdlParser$withLocation,
										locatedList,
										$author$project$HdlParser$BindingRecord(
					...
					[
						...
						A2(
							...
							$elm$parser$Parser$Advanced$succeed(
								function (d) {
									return $elm$parser$Parser$Advanced$Loop(
										A2($elm$core$List$cons, d, revDefs));
								}),
							$author$project$HdlParser$sps),
						A2(
							$elm$parser$Parser$Advanced$ignorer,
							$elm$parser$Parser$Advanced$oneOf(
								_List_fromArray(
									[
										$author$project$HdlParser$cyclic$bindingDef(),
										$author$project$HdlParser$cyclic$funcDef()
									])),
							$author$project$HdlParser$sps)),
						A2(
						$elm$parser$Parser$Advanced$map,
...
try {
	...
	$author$project$HdlParser$cyclic$bindingDef = function () {
		return $author$project$HdlParser$bindingDef;
	};
	var $author$project$HdlParser$defs = $author$project$HdlParser$cyclic$defs();
	$author$project$HdlParser$cyclic$defs = function () {
		return $author$project$HdlParser$defs;
	};
	var $author$project$HdlParser$funcDef = $author$project$HdlParser$cyclic$funcDef();
	$author$project$HdlParser$cyclic$funcDef = function () {
		return $author$project$HdlParser$funcDef;
	};
	var $author$project$HdlParser$locals = $author$project$HdlParser$cyclic$locals();
	$author$project$HdlParser$cyclic$locals = function () {
		return $author$project$HdlParser$locals;
	};
} catch ($) {
	throw 'Some top-level definitions from `HdlParser` are causing infinite recursion:\n\n  ┌─────┐\n  │    bindingDef\n  │     ↓\n  │    defs\n  │     ↓\n  │    funcDef\n  │     ↓\n  │    locals\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.1/bad-recursion to learn how to fix it!';}
...
var $author$project$HdlParser$parse = function (src) {
	return A2(
		...
		A2(
			...
			A2(
				$elm$parser$Parser$Advanced$ignorer,
				A2($elm$parser$Parser$Advanced$withIndent, 0, $author$project$HdlParser$defs),
...
var $author$project$HdlParser$showProblemContext = function (context) {
	switch (context.$) {
		case 'BindingDefContext':
			...
			var nameStr = $author$project$HdlParser$bindingTargetToString(bindingName.value);
...
var $author$project$HdlChecker$prettifyTypesHelper = F2(
	function (t1, t2) {
		var _v0 = _Utils_Tuple2(t1.value, t2.value);
		if ((_v0.a.$ === 'TRecord') && (_v0.b.$ === 'TRecord')) {
			var r1 = _v0.a.a;
			var r2 = _v0.b.a;
			return A3(
				$pzp1997$assoc_list$AssocList$foldl,
			...
			return $author$project$HdlChecker$emptySubst;
		}
	});
var $author$project$HdlChecker$prettifyTypes = F2(
	function (t1, t2) {
		var subst = A2($author$project$HdlChecker$prettifyTypesHelper, t1, t2);
		return _Utils_Tuple2(
			A2($author$project$HdlChecker$applySubstToType, subst, t1),
			A2($author$project$HdlChecker$applySubstToType, subst, t2));
	});
var $author$project$HdlParser$showProblemLocationRange = F5(
	function (startRow, startCol, endRow, endCol, src) {
		return A2(
			$elm$core$String$join,
			'\n',
			A2(
				...
				function (row) {
					...
					var line = $elm$core$String$fromInt(row) + ('| ' + $elm$core$String$trimLeft(rawLine));
					var offset = ($elm$core$String$length(line) - $elm$core$String$length(rawLine)) - 1;
					var underlineStartCol = _Utils_eq(row, startRow) ? (offset + startCol) : 1;
					var underlineEndCol = _Utils_eq(row, endRow) ? (offset + endCol) : $elm$core$String$length(line);
					var underline = A3($author$project$HdlParser$makeUnderline, line, underlineStartCol, underlineEndCol);
					return line + ('\n' + underline);
				},
				A2($elm$core$List$range, startRow, endRow)));
	});
var $author$project$HdlChecker$showLocation = F2(
	function (src, located) {
		var _v0 = located.to;
		var toRow = _v0.a;
		var toCol = _v0.b;
		var _v1 = located.from;
		var fromRow = _v1.a;
		var fromCol = _v1.b;
		return A5($author$project$HdlParser$showProblemLocationRange, fromRow, fromCol, toRow, toCol, src);
	});
var $author$project$HdlChecker$showLocationRange = F3(
...
var $author$project$HdlChecker$showProblem = F2(
	function (src, problem) {
		switch (problem.$) {
			...
			case 'WrongCallArity':
				var callee = problem.a;
				var paramTypes = problem.b;
				var locatedArgTypes = problem.c;
				var paramLength = $elm$core$List$length(paramTypes);
				var argTypes = A2(
					$elm$core$List$map,
					function ($) {
						return $.value;
					...
					locatedArgTypes);
				var argLength = $elm$core$List$length(argTypes);
				return 'I was expecting ' + ($elm$core$String$fromInt(paramLength) + (' arguments but got ' + ($elm$core$String$fromInt(argLength) + ('.\n' + (function () {
					if (locatedArgTypes.b) {
						var first = locatedArgTypes.a;
						var rests = locatedArgTypes.b;
						return A3(
							$author$project$HdlChecker$showLocationRange,
							src,
							first,
							A2(
								$elm$core$Maybe$withDefault,
				...
				}() + ('Hint: ' + ((_Utils_cmp(paramLength, argLength) > 0) ? ('Try adding ' + (function () {
					var _v2 = paramLength - argLength;
					if (_v2 === 1) {
						return '1 argument';
					} else {
						var difference = _v2;
						return $elm$core$String$fromInt(difference) + ' arguments';
					}
				}() + (' of type ' + (A2(
					$elm$core$String$join,
					' and ',
			...
			case 'InvalidIndexingTarget':
				...
				switch (_v4.$) {
					...
					case 'TFun':
						return 'I found that you are trying to index into a function. This is not allowed.\n' + (A3($author$project$HdlChecker$showLocationRange, src, from, to) + ('\n' + 'Hint: Try switching from the function to a bus.'));
					default:
			...
			case 'FromIndexBiggerThanToIndex':
				var from = problem.a;
				var to = problem.b;
				return 'I found that the start index ' + ($elm$core$String$fromInt(from.value) + (' is greater than ' + (' the end index ' + ($elm$core$String$fromInt(to.value) + ('.\n' + (A3($author$project$HdlChecker$showLocationRange, src, from, to) + ('\n' + ('Hint: Try limiting the start index to between 0 and ' + ($elm$core$String$fromInt(to.value) + '.')))))))));
			case 'MismatchedTypes':
				var expectedType = problem.a;
				var actualType = problem.b;
				var _v5 = A2($author$project$HdlChecker$prettifyTypes, expectedType, actualType);
				var prettyExpectedType = _v5.a;
				var prettyActualType = _v5.b;
				return 'I\'m expecting to find the type ' + ($author$project$HdlChecker$typeToString(prettyExpectedType.value) + (' here:\n' + (A2($author$project$HdlChecker$showLocation, src, prettyActualType) + ('\n' + ('but got the type ' + ($author$project$HdlChecker$typeToString(prettyActualType.value) + '.\n'))))));
			case 'BindingNotAllowedAtTopLevel':
				var bindingName = problem.a;
				return 'I found a binding called `' + ($author$project$HdlParser$bindingTargetToString(bindingName.value) + ('` at the top level of this unit here:\n' + (A2($author$project$HdlChecker$showLocation, src, bindingName) + ('\n' + ('but you are not allowed to define binding at the top level.\n' + 'Hint: Try defining a function instead of a binding.')))));
			case 'ExpectingRecord':
				var recordType = problem.a;
				return 'I\'m expecting a record here:\n' + A2($author$project$HdlChecker$showLocation, src, recordType);
			case 'UnexpectedBindingRecordKey':
				var recordKey = problem.a;
				var actualRecordType = problem.b;
				return 'I found that you are trying to retrieve an undefined record key `' + (recordKey.value + ('` here:\n' + (A2($author$project$HdlChecker$showLocation, src, recordKey) + ('\n' + ('Hint: Try referencing one of the defined keys: ' + A2(
					$elm$core$String$join,
					', ',
...
var $author$project$Editor$compileHdl = function (src) {
	var _v0 = $author$project$HdlParser$parse(src);
	if (_v0.$ === 'Err') {
		var err = _v0.a;
		return $elm$core$Result$Err(
			'❌ Parse error.\n\n' + A2($author$project$HdlParser$showDeadEnds, src, err));
	} else {
		var program = _v0.a;
		...
		if (_v1.$ === 'Ok') {
			...
			var problems = _v1.a;
			return $elm$core$Result$Err(
				'❌ Check error.\n' + A2($author$project$HdlChecker$showProblems, src, problems));
		}
	}
};
...
var $basti1302$elm_non_empty_array$Array$NonEmpty$decoderBase = F2(
	function (elementDecoder, fallback) {
		return A2(
			$elm$json$Json$Decode$andThen,
			function (list) {
				var _v0 = $basti1302$elm_non_empty_array$Array$NonEmpty$fromList(list);
				if (_v0.$ === 'Just') {
					var nea = _v0.a;
					return $elm$json$Json$Decode$succeed(nea);
				} else {
					return fallback;
				}
			},
...
var $basti1302$elm_non_empty_array$Array$NonEmpty$decoder = function (elementDecoder) {
	return A2(
		$basti1302$elm_non_empty_array$Array$NonEmpty$decoderBase,
		elementDecoder,
		$elm$json$Json$Decode$fail('Cannot decode an empty JSON array to a NonEmptyArray.'));
};
...
var $author$project$Editor$decodeModel = function () {
	var decodeUnit = A3(
			...
			return A3(
				...
				function (source) {
					return $elm$json$Json$Decode$succeed(
						{
							name: name,
							output: $author$project$Editor$compileHdl(source),
							source: source,
							truthTable: $elm$core$Dict$empty
						});
				});
		});
	var decodeUnits = $basti1302$elm_non_empty_array$Array$NonEmpty$decoder(decodeUnit);
	return A2(
		$elm$json$Json$Decode$map,
		function (units) {
			return {editingActiveUnitName: false, units: units};
		},
		decodeUnits);
}();
...
var $author$project$Editor$preludeLength = 1;
var $elm$json$Json$Encode$string = _Json_wrap;
var $author$project$Editor$generateTruthTable = function (output) {
	if (output.$ === 'Err') {
		return $elm$core$Platform$Cmd$none;
	} else {
		var defs = output.a;
		if (_Utils_cmp(
			$elm$core$List$length(defs),
			$author$project$Editor$preludeLength) > 0) {
...
var $author$project$Editor$getActiveUnit = function (model) {
	return $basti1302$elm_non_empty_array$Array$NonEmpty$getSelected(model.units);
};
...
var $author$project$Editor$init = function (storedModel) {
	var defaultSource = 'xor a[n] b[n] -> [n] =\n    let\n        nand_a_b = nand a b\n    in\n    nand\n    (nand a nand_a_b)\n    (nand b nand_a_b)\n\nor a[n] b[n] -> [n] =\n    nand (not a) (not b)\n\nnot a[n] -> [n] =\n    nand a a\n\nand a[n] b[n] -> [n] =\n    let\n        nand_a_b = nand a b\n    in\n    nand nand_a_b nand_a_b\n    ';
	var defaultOutput = $author$project$Editor$compileHdl(defaultSource);
	var defaultModel = {
		editingActiveUnitName: false,
		units: $basti1302$elm_non_empty_array$Array$NonEmpty$fromElement(
			{name: 'Basics', output: defaultOutput, source: defaultSource, truthTable: $elm$core$Dict$empty})
	};
	var model = function () {
		if (storedModel.$ === 'Nothing') {
			return defaultModel;
		} else {
			var modelJson = storedModel.a;
			return A2(
				$elm$core$Result$withDefault,
				defaultModel,
				A2($elm$json$Json$Decode$decodeValue, $author$project$Editor$decodeModel, modelJson));
		}
	}();
	var activeUnit = $author$project$Editor$getActiveUnit(model);
	return _Utils_Tuple2(
		model,
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					$author$project$Editor$setEditorValuePort(activeUnit.source),
					$author$project$Editor$generateTruthTable(activeUnit.output)
				])));
};
...
var $author$project$Editor$StoreModel = function (a) {
	return {$: 'StoreModel', a: a};
};
...
var $author$project$Editor$pageWillClosePort = _Platform_incomingPort(
	'pageWillClosePort',
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				$author$project$Editor$pageWillClosePort($author$project$Editor$StoreModel)
			]));
};
var $author$project$Editor$addTabPort = _Platform_outgoingPort('addTabPort', $elm$json$Json$Encode$int);
...
var $basti1302$elm_non_empty_array$Array$NonEmpty$push = F2(
	function (element, _v0) {
		...
		return A3(
			...
			first,
			selected,
			A2($elm$core$Array$push, element, rest));
	});
...
var $author$project$Editor$addUnit = F2(
	function (name, model) {
		var newUnit = {
			name: name,
		...
		return _Utils_update(
			model,
			{
				units: A2(
					...
					A2($basti1302$elm_non_empty_array$Array$NonEmpty$push, newUnit, model.units))
			});
	});
...
var $basti1302$elm_non_empty_array$Array$NonEmpty$selectedIndex = function (_v0) {
	var selected = _v0.b;
	return selected;
};
...
var $basti1302$elm_non_empty_array$Array$NonEmpty$updateSelected = F2(
	function (_function, nea) {
		var index = $basti1302$elm_non_empty_array$Array$NonEmpty$selectedIndex(nea);
		var element = $basti1302$elm_non_empty_array$Array$NonEmpty$getSelected(nea);
		return A3(
...
var $author$project$Editor$updateActiveUnit = F2(
	function (updateUnit, model) {
		return _Utils_update(
			model,
			{
				units: A2($basti1302$elm_non_empty_array$Array$NonEmpty$updateSelected, updateUnit, model.units)
			});
	});
var $author$project$Editor$editActiveUnitName = F2(
	function (newName, model) {
		return A2(
			$author$project$Editor$updateActiveUnit,
			function (activeUnit) {
				return _Utils_update(
					activeUnit,
					{name: newName});
...
var $basti1302$elm_non_empty_array$Array$NonEmpty$toList = function (_v0) {
	var first = _v0.a;
	var rest = _v0.c;
	return A2(
		$elm$core$List$cons,
		first,
		$elm$core$Array$toList(rest));
};
var $basti1302$elm_non_empty_array$Array$NonEmpty$encode = F2(
	function (encodeElement, nea) {
		return A2(
			$elm$json$Json$Encode$list,
			encodeElement,
			$basti1302$elm_non_empty_array$Array$NonEmpty$toList(nea));
	});
var $author$project$Editor$encodeModel = function (model) {
	var encodeUnit = function (unit) {
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					...
					_Utils_Tuple2(
					'source',
					$elm$json$Json$Encode$string(unit.source))
				]));
	};
...
var $author$project$Editor$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'EditorValueChanged':
				var newValue = msg.a;
				var output = $author$project$Editor$compileHdl(newValue);
				return _Utils_Tuple2(
					A2(
						$author$project$Editor$updateActiveUnit,
						function (activeUnit) {
							return _Utils_update(
								activeUnit,
								{output: output, source: newValue});
						},
						model),
					$author$project$Editor$generateTruthTable(output));
			case 'TruthTableReceived':
				var tableJson = msg.a;
				return _Utils_Tuple2(
					A2(
						$author$project$Editor$updateActiveUnit,
			...
			case 'StartEditingActiveUnitName':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{editingActiveUnitName: true}),
					$elm$core$Platform$Cmd$none);
			case 'EditActiveUnitName':
				var newName = msg.a;
				return _Utils_Tuple2(
					A2($author$project$Editor$editActiveUnitName, newName, model),
					$elm$core$Platform$Cmd$none);
			case 'StopEditingActiveUnitName':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{editingActiveUnitName: false}),
			...
			default:
				return _Utils_Tuple2(
					model,
					$author$project$Editor$storeModelPort(
						$author$project$Editor$encodeModel(model)));
		}
	});
																				...
																				$elm$core$String$fromInt(
																					function () {
																						if (value >= 0) {
																							...
																							var numberOfDigits = _Utils_eq(value, -1) ? 1 : $elm$core$Basics$ceiling(
																								A2($elm$core$Basics$logBase, 2, -value));
																							return value + A2($elm$core$Basics$pow, 2, numberOfDigits);
																						}
																					}()))
																			]));
																},
...
var $author$project$Editor$viewRightPanel = function (model) {
	var activeUnit = $author$project$Editor$getActiveUnit(model);
	var _v0 = activeUnit.output;
	if (_v0.$ === 'Ok') {
		return $author$project$Editor$viewTruthTable(activeUnit.truthTable);
	} else {
		var str = _v0.a;
...
var $author$project$Editor$ChangeTab = function (a) {
	return {$: 'ChangeTab', a: a};
};
var $author$project$Editor$EditActiveUnitName = function (a) {
	return {$: 'EditActiveUnitName', a: a};
};
var $author$project$Editor$StartEditingActiveUnitName = {$: 'StartEditingActiveUnitName'};
var $author$project$Editor$StopEditingActiveUnitName = {$: 'StopEditingActiveUnitName'};
...
var $basti1302$elm_non_empty_array$Array$NonEmpty$indexedMap = F2(
	function (_function, _v0) {
		...
		var newRest = A2(
			...
			function (idx) {
				return _function(idx + 1);
			},
			rest);
		var newFirst = A2(_function, 0, first);
		return A3($basti1302$elm_non_empty_array$Array$NonEmpty$NEA, newFirst, selected, newRest);
	});
...
var $author$project$Editor$toElmUiColor = function (color) {
...
var $author$project$Editor$styles = {
	lightGrey: $author$project$Editor$toElmUiColor($avh4$elm_color$Color$lightGrey),
	white: $author$project$Editor$toElmUiColor($avh4$elm_color$Color$white)
};
...
var $author$project$Editor$viewTabSelector = function (model) {
	...
	return A2(
		...
		_Utils_ap(
			$basti1302$elm_non_empty_array$Array$NonEmpty$toList(
				A2(
					$basti1302$elm_non_empty_array$Array$NonEmpty$indexedMap,
					F2(
						function (index, unit) {
							return (model.editingActiveUnitName && _Utils_eq(index, activeUnitIndex)) ? A2(
								$mdgriffith$elm_ui$Element$Input$text,
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$Events$onLoseFocus($author$project$Editor$StopEditingActiveUnitName)
									]),
								{
									label: $mdgriffith$elm_ui$Element$Input$labelHidden('edit active unit name'),
									onChange: $author$project$Editor$EditActiveUnitName,
									...
									]),
								{
									...
									onPress: _Utils_eq(index, activeUnitIndex) ? $elm$core$Maybe$Just($author$project$Editor$StartEditingActiveUnitName) : $elm$core$Maybe$Just(
										$author$project$Editor$ChangeTab(index))
								});
						}),
					model.units)),
			_List_fromArray(
				[$author$project$Editor$viewAddTab])));
};
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Editor$viewTabSelector(model)
				])));
};
